...
const StyledFirebaseAuth = ({
  ...
  useEffect(() => {
    ...
    import("firebaseui").then((firebaseui) => setFirebaseui(firebaseui));
  }, []);
  ...
  useEffect(() => {
    ...
    // currentはここでは必ずElement型だが型解決のためにas any
    firebaseUiWidget.start(elementRef.current as any, uiConfig);
